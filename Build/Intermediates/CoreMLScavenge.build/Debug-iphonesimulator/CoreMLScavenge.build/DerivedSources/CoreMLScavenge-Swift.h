...
SWIFT_MODULE_NAMESPACE_PUSH("CoreMLScavenge")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC14CoreMLScavenge11AppDelegate")
...
SWIFT_CLASS("_TtC14CoreMLScavenge14ViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified objectLabel;
...
@interface ViewController (SWIFT_EXTENSION(CoreMLScavenge)) <AVCaptureVideoDataOutputSampleBufferDelegate>
